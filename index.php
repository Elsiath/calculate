...
<div class="container">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2 d-flex flex-row align-items-center">
            <input type="text" class="form-control" id="Rate" placeholder="Rate" value="0">
            <span class="ml-2">RUB</span>
        </div>
    </div>
    <div class="form-group row">
        <label for="NumberAdults" class="col-sm-2 col-form-label">Number of adults</label>
        <div class="col-sm-2 d-flex flex-row align-items-center">
            <input type="text" class="form-control" id="NumberAdults" placeholder="Number" value="0">
        </div>
    </div>
    <div class="form-group row">
        <label for="NumberStudents" class="col-sm-2 col-form-label">Number of children/students</label>
        <div class="col-sm-2 d-flex flex-row align-items-center">
            <input type="text" class="form-control" id="NumberStudents" placeholder="Number" value="0">
        </div>
    </div>
    <div class="form-group row">
        <label for="TotalNumber" class="col-sm-2 col-form-label">Total pax in the group</label>
        <div class="col-sm-2 d-flex flex-row align-items-center">
            <input type="text" class="form-control" id="TotalNumber" placeholder="" readonly>
        </div>
    </div>
    <div class="form-group row">
...
<script>
    ...
    $("#NumberAdults, #NumberStudents").change(function() {
        $('#TotalNumber').val(parseInt($('#NumberAdults').val())+parseInt($('#NumberStudents').val()));
    });
</script>
</body>
